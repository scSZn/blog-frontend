...
export const constantRoutes = [
...

  {
    ...
    children: [
      {
        path: 'publish',
        component: () => import('@/views/admin/blog/publish'),
        meta: { title: '发布博客', icon: 'create-blog' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'blog',
        name: 'ManageBlog',
        component: () => import('@/views/admin/manage/blog'),
        meta: { title: '博客管理', icon: 'blog-management' }
      },
      {
        path: 'tag',
        name: 'ManageTag',
        component: () => import('@/views/admin/manage/tag'),
        meta: { title: '标签管理', icon: 'tag-management' }
      },
      {
        path: 'series',
        name: 'ManageSeries',
        component: () => import('@/views/admin/manage/series'),
        meta: { title: '文章系列管理', icon: 'series-management' }
      }
    ]
  },
